          ...
          <div className="row">
            <div className="col-xs-12 col-sm-6 col-md-3">
              <div className="widget subscribe no-box">
                ...
                <p>
                  I'm a software developer – close knit and a little crazy –
                  providing the world&#8217;s most exclusive art form from our
                  headquarters in Tunisia . I provide here beautiful AI artworks
                  because we believe each one is a representation of the pivotal
                  turning point for the art market and art history.{" "}
                </p>
              </div>
            </div>
            <div className="col-xs-12 col-sm-6 col-md-3">
            ...
            <div className="col-xs-12 col-sm-6 col-md-3">
              <div className="widget no-box">
                ...
                <p>
                  <a href="mailto:hassen@domain.com" title="glorythemes">
                    hassen@domain.com
                  </a>
                </p>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12 text-center">
              <p>Copyright Hassen KHROUF © 2022. All rights reserved.</p>
            </div>
          </div>
        </div>
      </div>
